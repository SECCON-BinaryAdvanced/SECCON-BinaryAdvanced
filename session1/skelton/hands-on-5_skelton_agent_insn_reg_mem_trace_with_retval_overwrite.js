...
function overwrite_retval(retval, fake_tm) {
    ...
    const tm_ptr = retval;
    tm_ptr.___(0).________(fake_tm.tm_sec);
    tm_ptr.___(4).________(fake_tm.tm_min);
    tm_ptr.___(8).________(fake_tm.tm_hour);
    tm_ptr.___(12).________(fake_tm.tm_mday);
    tm_ptr.___(16).________(fake_tm.tm_mon);
    tm_ptr.___(20).________(fake_tm.tm_year);
    tm_ptr.___(24).________(fake_tm.tm_wday);
    tm_ptr.___(28).________(fake_tm.tm_yday);
    tm_ptr.___(32).________(fake_tm.tm_isdst);
